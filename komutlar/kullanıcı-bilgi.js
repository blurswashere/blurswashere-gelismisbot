...
// Belirtilen kullanıcın bilgilerine bakarsınız.
...
moment.locale('tr-TR');
  ...
  if (!member) return message.reply('Bir kullanıcı belirt <prefix>profil @kullanıcı veya <prefix>profil <Kullanıcı_ID> ')
